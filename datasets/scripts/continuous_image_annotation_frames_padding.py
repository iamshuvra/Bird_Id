...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root_path', default="/home/shuvra/projects/Bird Identification/data/FBD-SV-2024/", type=str,
    ...
    train_img_label_txt_file = "/home/shuvra/projects/Bird Identification/datasets/dataloader/img_label_" + num_to_chinese_c_dic[args.input_img_num] + "_continuous_difficulty_train_raw.txt"
    val_img_label_txt_file = "/home/shuvra/projects/Bird Identification/datasets/dataloader/img_label_" + num_to_chinese_c_dic[args.input_img_num] + "_continuous_difficulty_val_raw.txt"
