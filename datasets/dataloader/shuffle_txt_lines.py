...
# the shuffle is useful for creating a random order of the data
root_path = "/home/shuvra/projects/Bird Identification/datasets/dataloader/"
...
if __name__ == '__main__':
    ...
    for in_file, out_file in zip(in_files, out_files):
        out = open(root_path + out_file, "w")
        lines = []
        with open(root_path + in_file, "r") as infile:
            for line in infile:
                lines.append(line)
